...
先读取 `.aidlc/system/workflow/protocol.md`、`.aidlc/system/workflow/stages.json`、`.aidlc/system/prompts/common.md`、当前 work 状态，再读取 `.aidlc/system/prompts/architecture.md`。只在当前阶段被路由到 Architecture 时生成正式产物。
